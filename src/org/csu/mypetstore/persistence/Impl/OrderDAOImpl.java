...
public class OrderDAOImpl implements OrderDAO {
    ...
    public List<Order> getOrdersByUsername(String username) {
        ...
        try{
            ...
            PreparedStatement preparedStatement = conn.prepareStatement(GET_ORDER_BY_USERNAME);
    ...
    public Order getOrder(int orderId) {
        ...
        try{
            Connection conn = DBUtil.getconn();
            PreparedStatement preparedStatement = conn.prepareStatement(GET_ORDER);
    ...
    public void insertOrder(Order order) {
        try{
            Connection conn = DBUtil.getconn();
            PreparedStatement preparedStatement = conn.prepareStatement(INSERT_ORDER);
    ...
    public void insertOrderStatus(Order order) {
        try{
            Connection conn = DBUtil.getconn();
            PreparedStatement preparedStatement = conn.prepareStatement(INSERT_ORDER_STATUS);
            preparedStatement.setInt(1,order.getOrderId());
